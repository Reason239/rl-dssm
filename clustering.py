...
save_path = pathlib.Path(experiment_path_base + experiment_name + clustering_name)
...
path_x_raw = save_path / 'x_raw.pkl'
if path_x_raw.exists():
    print('Loading precomputed vectors')
    with open(path_x_raw, 'rb') as f:
        x_raw = pickle.load(f)
else:
